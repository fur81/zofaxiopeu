...
function html_footer( $p_file = null ) {
	...
	if( ON == config_get( 'show_version' ) ) {
		...
		$t_mantis_href = '<a href="http://www.mantisbt.org/" title="Medicnexus"';
		echo
			"\t", '<span class="timer">',
	...
	echo "\t<address>Copyright &copy; 2013 - ", date( 'Y' ), " Medicnexus</address>\n";
	...
	if ( !is_page_name( 'login_page' ) ) {
		...
		echo '<a href="http://www.medicnexus.com" title="Medicnexus"><img src="' . helper_mantis_url( 'images/mantis_logo.png' ) . '" width="145" height="50" alt="Powered by Mantis Bugtracker" border="0" /></a>';
		echo '</div>', "\n";
	}
