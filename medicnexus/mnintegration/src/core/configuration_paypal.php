...
define('PAYPAL_SHIPPING_SECOND_OPINION',     '1.50');
define('PAYPAL_TAX_SECOND_OPINION',          '1.50');
define('PAYPAL_TOTAL_AMOUNT_SECOND_OPINION','15.00');
...
define('PAYPAL_SHIPPING_RAPID_CONSULTATION',     '1.25');
define('PAYPAL_TAX_RAPID_CONSULTATION',          '1.25');
define('PAYPAL_TOTAL_AMOUNT_RAPID_CONSULTATION','12.50');
...
define('PAYPAL_SHIPPING_VIRTUAL_CONSULTATION',     '1.75');
define('PAYPAL_TAX_VIRTUAL_CONSULTATION',          '1.75');
define('PAYPAL_TOTAL_AMOUNT_VIRTUAL_CONSULTATION','26.50');
...
define('PAYPAL_SHIPPING_HEALTH_PROGRAM',     '6.00');
define('PAYPAL_TAX_HEALTH_PROGRAM',          '6.00');
define('PAYPAL_TOTAL_AMOUNT_HEALTH_PROGRAM','18.00');
