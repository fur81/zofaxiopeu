...
$values['query'] = array(
		...
		'updateEmail' => 'UPDATE mantis_user_table SET email = "%email%" WHERE username = "%username%";',

		'updateLanguage' => 'UPDATE mantis_user_pref_table SET language = "%language%" WHERE user_id = (
