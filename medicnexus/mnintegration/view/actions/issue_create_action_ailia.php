...
if ( isset($_GET['success'])) {
	...
	//20140519: añadido x Ailía 
	$payment = Payment::get($_SESSION['paymentId'], getApiContext());
	...
	$payment = $payment->execute($paymentExecution, $apiContext);
		...
		$_SESSION ['msg'] = 'msg_info_consult_inserted'. $_SESSION['paymentId']; //20140519 toda la concatenación es adicional a lo original
	}else{
