		    ...
		    <tr class="<?php echo "row$k"; ?>">
			  ...
			  <td valign="top" class="button">
                ...
                if ( strtolower($field->Type)=='readonlytext'){
                        ...
                        <?php if (FALANG_J30) { ?>
            					<a class="button btn" onclick="document.adminForm.refField_<?php echo $field->Name;?>.value = document.adminForm.origText_<?php echo $field->Name;?>.value;"><i class="icon-copy"></i><?php echo JText::_('Copy'); ?></a>
                        <?php } else { ?>
				...
				<?php }	else { ?>
                  <?php if (FALANG_J30) { ?>
                        <a class="button btn" onclick="copyToClipboard('<?php echo $field->Name;?>','copy');"><i class="icon-copy"></i><?php echo JText::_('Copy'); ?></a>
                      <?php } else { ?>
